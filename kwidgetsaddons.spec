...
Source0  : https://download.kde.org/stable/frameworks/5.108/kwidgetsaddons-5.108.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.108/kwidgetsaddons-5.108.0.tar.xz.sig
...
%prep
%setup -q -n kwidgetsaddons-5.108.0
cd %{_builddir}/kwidgetsaddons-5.108.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688869153
mkdir -p clr-build
pushd clr-build
