...
Source0  : https://download.kde.org/stable/frameworks/5.103/kwidgetsaddons-5.103.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.103/kwidgetsaddons-5.103.0.tar.xz.sig
...
%prep
%setup -q -n kwidgetsaddons-5.103.0
cd %{_builddir}/kwidgetsaddons-5.103.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676859388
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5WidgetsAddons.so.5.103.0
