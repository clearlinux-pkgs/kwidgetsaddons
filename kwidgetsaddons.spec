...
Version  : 6.4.1
Release  : 85
URL      : https://download.kde.org/stable/frameworks/6.4/kwidgetsaddons-6.4.1.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.4/kwidgetsaddons-6.4.1.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.4/kwidgetsaddons-6.4.1.tar.xz.sig
...
%setup -q -n kwidgetsaddons-6.4.1
cd %{_builddir}/kwidgetsaddons-6.4.1
pushd ..
cp -a kwidgetsaddons-6.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721409017
mkdir -p clr-build
pushd clr-build
