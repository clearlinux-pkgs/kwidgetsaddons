...
Source0  : https://download.kde.org/stable/frameworks/5.56/kwidgetsaddons-5.56.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.56/kwidgetsaddons-5.56.0.tar.xz.sig
...
%prep
%setup -q -n kwidgetsaddons-5.56.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1552143941
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5WidgetsAddons.so.5.56.0
